...
Grilled_onions = 1
Tax = 0.07
order = str(input("Please State your full order:"))
if order == "hot dog":
    ...
    print("Your total is",
          ((Hot_Dog + Grilled_onions + Cheese + Peppers) * Tax) + (Hot_Dog + Grilled_onions + Peppers + Cheese))
...
if order == "chili dog":
    ...
    print("Your total is",
          ((Chili_Dog + Grilled_onions + Cheese + Peppers) * Tax) + (Chili_Dog + Grilled_onions + Peppers + Cheese))
